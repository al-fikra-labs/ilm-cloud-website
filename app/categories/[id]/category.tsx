...
export function CategoryDetailPage({category}: {category: ApiCategory}) {
    ...
    const handlePlayTrack = (track: ApiTrack) => {
        ...
        const playlist = category.tracks.map(convertApiTrackToTrack)
        ...
        <div className="space-y-8">
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 text-sm text-muted-foreground">
                    <span>{category.tracks.length} courses available</span>
                    <span>•</span>
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <Button
                        ...
                        onClick={() => category.tracks.length > 0 && handlePlayTrack(category.tracks[0])}
                                ...
                                {viewMode === "grid" ? (
                                    <>
                                        <div className="aspect-video bg-muted rounded-md mb-4 relative overflow-hidden">
                                            <img
                                                src={track.thumbnail || `/placeholder.svg?height=200&width=300&query=${track.name}`}
                                                alt={track.name}
                                        ...
                                        <h3 className="font-semibold mb-2 line-clamp-2">{track.name}</h3>
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div className="w-20 h-20 bg-muted rounded-md overflow-hidden flex-shrink-0">
                                            <img
                                                src={track.thumbnail || `/placeholder.svg?height=80&width=80&query=${track.name}`}
                                                alt={track.name}
